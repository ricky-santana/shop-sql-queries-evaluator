...
SELECT p.nombre FROM producto p WHERE p.precio = (SELECT l.precio FROM producto l WHERE l.codigo_fabricante = (SELECT f.codigo FROM fabricante f WHERE f.nombre = 'Lenovo') ORDER BY l.precio DESC LIMIT 1);
